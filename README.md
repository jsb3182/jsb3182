# 🗺️ Jeong Seong-beom | Geospatial & Open-Source GIS Analyst

> **공간 데이터 분석과 오픈소스 GIS 기술을 활용해 현실의 문제를 해결하는 분석가/개발자 정성범입니다.**  
> 공간정보 엔지니어링을 바탕으로 QGIS, Python, PostGIS 및 웹 GIS 파이프라인 구축에 집중하고 있습니다.

---

### 📌 About Me

* 🏢 **한국교육시설안전원** | 공간정보 행정원 (학구도 DB 관리 및 공간정보 구축)
* 🎓 **LX한국국토정보공사 공간정보아카데미** | 12기 수료 (웹 GIS 풀스택 및 공간 분석)
* 🎓 **남서울대학교** | 드론공간정보공학과 졸업 (20학번 / 캡스톤 디자인 프로젝트 조장)
...
<p>
  ...
  <img src="https://img.shields.io/badge/GeoServer-397AAB?style=flat-square&logo=geoserver&logoColor=white"/>
